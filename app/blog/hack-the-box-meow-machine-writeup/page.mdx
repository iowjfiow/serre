...
export const metadata = articleMetadata({
  title: "HackTheBox Meow Writeup – Telnet Misconfiguration",
  description:
    "Step-by-step writeup of HackTheBox Meow, a beginner Starting Point machine. Learn how to exploit a misconfigured Telnet service with blank-password root login and capture the flag.",
